...
print("\nSecuencia de numeros del 0 al 9:")
for num in range(10):
    print(num)

# range(inicio, fin)
print("\nSecuencia de numeros con range(inicio, fin): ")
for num in range(5, 10):
    print(num)

# range(inicio, fin, paso)
print("\nSecuencia de numeros con range(inicio, fin, paso): ")
for num in range(0, 50, 5):
    print(num)

print("\nSecuencia de numeros con range(inicio negativo, fin): ")
for num in range(-5, 0):
    print(num)

print("\nSecuencia de numeros con range(inicio, fin, paso decrementando 1): ")
for num in range(10, 0, -1):
    print(num)

print("\nList de numeros con range(): ")
nums = range(10)
